    ...
    <div class="product-card">
      <div class="row g-4 align-items-center">
        ...
        <div class="col-md-6">
          ...
          <?php if ($isLoggedIn): ?>
            <form action="cart.php" method="post" class="d-flex gap-2 align-items-center flex-wrap">
              <input type="hidden" name="product_id" value="<?= $product['product_id'] ?>">
              <input type="number" name="quantity" class="form-control" value="1" min="1" max="<?= $product['stock'] ?>" style="width:100px;">
              <button type="submit" class="btn btn-success"><i class="fas fa-cart-plus me-1"></i> เพิ่มในตะกร้า</button>
            </form>
          <?php else: ?>
