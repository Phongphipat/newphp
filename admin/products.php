...
<style>
    body {
        background: linear-gradient(135deg, #3acfd5, #3a4ed5, #00aaff);
    ...
    .card:hover {
        ...
        box-shadow: 0 18px 40px rgba(0, 150, 255, 0.3);
    }
    ...
    .btn-primary:hover {
        background: linear-gradient(90deg, #0099ff, #005ce6);
    ...
    .btn-secondary:hover {
        ...
        box-shadow: 0 6px 18px rgba(47, 128, 237, 0.6);
        transform: translateY(-2px);
    }
</style>
